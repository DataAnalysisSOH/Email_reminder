...
# ]
sheet_info_list = [
    {"id": "1MgQAUtQ64SXZXHg1CGdmo-uoHqWitHzynXCKCpB1RkQ", "worksheet": "Revenue Report_PSM", "cell_address": "B1", "receiver": [EMAIL_RECEIVER_ERROR, EMAIL_RECEIVER_NORMAL],"Report_name":"ScoreCard_AB_n_PSM"},
    {"id": "16wtqJqEvLJC3SI-h7aBcI-ek9sl1aHdIBqrrlyMc8z0", "worksheet": "YTD_QB_Report1", "cell_address": "B3", "receiver": [EMAIL_RECEIVER_ERROR, EMAIL_RECEIVER_NORMAL],"Report_name":"ScoreCard_SOH"},
...
# schedule.every(0.1).minutes.do(check_refresh_and_send_email(sheet_info["id"],
#         sheet_info["worksheet"],
#         sheet_info["cell_address"],
#         sheet_info["receiver"],
#         sheet_info["Report_name"]))
